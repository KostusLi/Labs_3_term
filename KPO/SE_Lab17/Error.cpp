...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY_NODEF(101), ERROR_ENTRY(102, "Пустой файл"), ERROR_ENTRY_NODEF(103),
		...
		ERROR_ENTRY(202, "Идентификатор не найден"), ERROR_ENTRY(203, "Лексема не найдена"), ERROR_ENTRY(206, "Строка слишком длинная"),
		ERROR_ENTRY(205, "Число слишком большое"), ERROR_ENTRY(103, "Некорректный символ"),
